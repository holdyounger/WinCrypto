...
extern FuncPtr_NtQueryInformationProcess Ptr_NtQueryInformationProcess;
 ...
 FuncPtr_MD4Init Ptr_MD4Init;
 FuncPtr_MD4Update Ptr_MD4Update;
 FuncPtr_MD4Final Ptr_MD4Final;

 FuncPtr_MD5INIT Ptr_MD5Init;
 FuncPtr_MD5UPDATE Ptr_MD5Update;
 FuncPtr_MD5FINAL Ptr_MD5Final;


#ifdef __cplusplus
extern "C" {
#endif
extern BOOL kull_m_ntdll_init();
#ifdef __cplusplus
}
#endif
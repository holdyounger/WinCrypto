...
BOOL kull_m_ntdll_init()
{
	...
	if (cryptDll)
	{
		Ptr_MD5Init = (FuncPtr_MD5INIT)GetProcAddress(cryptDll, "MD5Init");
		Ptr_MD5Update = (FuncPtr_MD5UPDATE)GetProcAddress(cryptDll, "MD5Update");
		Ptr_MD5Final = (FuncPtr_MD5FINAL)GetProcAddress(cryptDll, "MD5Final");

		Ptr_MD4Init = (FuncPtr_MD4Init)GetProcAddress(cryptDll, "MD4Init");
		Ptr_MD4Update = (FuncPtr_MD4Update)GetProcAddress(cryptDll, "MD4Update");
		Ptr_MD4Final = (FuncPtr_MD4Final)GetProcAddress(cryptDll, "MD4Final");
	}
